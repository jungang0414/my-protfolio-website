...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const inputs = e.terget.elements;
    const data = {};
  ...
  return (
    <form
      ...
      method="POST"
      className="flex flex-col lg:w-[calc(100%-30%)] md:w-[calc(100%-10%)] w-full mx-auto mt-10 border-gray-300 border p-4 rounded shadow-lg bg-gray-200"
    >
